        ...
        private class DomainMessageDispenser : MessageDispenser
        {
            ...
            protected override string GetMessage( int number )
            {
                switch ( number )
                {
                    ...
                    case 13:
                        return "ImplicitOperationManagementAttribute: automatic analysis of property {0} failed. Place NestedTrackedObjectAttribute on field or property containing tracked object.";
