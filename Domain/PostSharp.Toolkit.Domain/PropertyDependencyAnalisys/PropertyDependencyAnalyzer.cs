    ...
    internal class PropertiesDependencieAnalyzer
    {
        ...
        private class MethodAnalyzer : SyntaxTreeVisitor
        {
                ...
                public bool IsNotifyPropertyChangedSafeProperty
                {
                    get
                    {
                        return this.isNotifyPropertyChangedSafeProperty ??
                               (this.isNotifyPropertyChangedSafeProperty =
                                this.CurrentProperty.GetCustomAttributes( typeof(NotifyPropertyChangedSafeAttribute), false ).Any()).Value;
                    }
                }
            ...
            private sealed class ExpressionValidatorRepository
            {
                ...
                private ExpressionValidationResult ProcessResults(
                    IEnumerable<ExpressionValidationResultWithErrors> validationResults, AnalysisContext currentContext )
                {
                    ...
                    foreach ( ExpressionValidationResultWithErrors resultWithErrors in rejectedResults.Value )
                    {
                        ...
                        DomainMessageSource.Instance.Write(
                            currentContext.CurrentProperty, resultWithErrors.SeverityType, resultWithErrors.MessageId, resultWithErrors.MessageArguments );
                    }
            ...
            private sealed class VirtualMethodCallValidator : IMethodCallValidator
            {
                public ExpressionValidationResultWithErrors ValidateMethod( IMethodCallExpression methodCallExpression, AnalysisContext currentContext )
                {
            ...
            {
                public static readonly ExpressionValidationResultWithErrors AcceptImidietReturn =
                    new ExpressionValidationResultWithErrors( ExpressionValidationResult.AcceptImmediateReturn );

                public static readonly ExpressionValidationResultWithErrors Abstain =
                    new ExpressionValidationResultWithErrors( ExpressionValidationResult.Abstain );
