    ...
    internal static class NotifyPropertyChangedAccessor
    {
        internal class NotifyPropertyChangedTypeAccessors
        {
            ...
            public NotifyPropertyChangedTypeAccessors( Type type )
            {
                ...
                this.raisePropertyChangedAction =
                    Expression.Lambda<Action<object, string>>(
                        Expression.Call( Expression.Convert( objectParameter, type ), "OnPropertyChanged", null, propertyParameter ),
                        objectParameter,
                ...
                try
                {
                    ...
                    this.raiseChildPropertyChangedAction =
                        Expression.Lambda<Action<object, string>>(
                            Expression.Call(
                                Expression.Convert( objectParameter, type ), "____PostSharpToolkitsDomain_OnChildPropertyChanged____", null, propertyParameter ),
                            objectParameter,
                            propertyParameter ).Compile();
                    ...
                    this.removeChildPropertyChangedHandlerAction =
                        Expression.Lambda<Action<object, EventHandler<ChildPropertyChangedEventArgs>>>(
                            Expression.Call(
                                ...
                                "remove_____PostSharpToolkitsDomain_ChildPropertyChanged____",
                                null,
                                handlerParameter ),
                            objectParameter,
                            handlerParameter ).Compile();
                ...
                {
                    throw new NotInstrumentedClassInDependsOnException(
                        string.Format( "Type {0} is not instrumented by NotifyPropertyChangedAttribute", type.Name ) );
                }
            }

            public void RaisePropertyChanged( object obj, string propertyName )
            {
                this.raisePropertyChangedAction.Invoke( obj, propertyName );
            }

            public void RaiseChildPropertyChanged( object obj, string propertyPath )
            {
                this.raiseChildPropertyChangedAction.Invoke( obj, propertyPath );
            }
